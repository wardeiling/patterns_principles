...
if(knitr::is_html_output()){
  ...
  schedule$Topic[!is.na(schedule$file)] <- paste0("<a href='", schedule$file[!is.na(schedule$file)], "'>", schedule$Topic[!is.na(schedule$file)], "</a>")
  DT::datatable(schedule[,  c("Dates", "Activities", "Topic", "Assessment")], options = list(pageLength = nrow(schedule)), autoHideNavigation = TRUE, rownames = FALSE, escape = FALSE)
}

if(knitr::is_latex_output()){
  kableExtra::kbl(schedule[,  c("Dates", "Activities", "Topic", "Assessment")])
}
