...
cat(paste0("* ", strsplit(schedule$Reading[which(schedule$file == "strategic_ambiguity.qmd")], split = "\n")[[1]]), sep = "\n")
```
...
In this graph, you connect concepts (propositions, in the language of PBTS) with one-sided arrows to indicate the direction of causality. We will return to the DAG in [Week 5](https://cjvanlissa.github.io/patterns_principles/formal_theory.html) and [Week 7](https://cjvanlissa.github.io/patterns_principles/causal_discovery.html).
