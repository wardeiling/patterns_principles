...
```{r include = TRUE, eval = TRUE, echo = FALSE, fig.align='center', out.width = "100%", fig.cap="Conceptual workflow for this task."}
...
```{r  include = TRUE, eval = TRUE, echo = FALSE, out.width = "100%", fig.cap="Front Page of a 'GitHub' Repository"}
...
```{r include = TRUE, eval = TRUE, echo = FALSE, fig.align='center', out.width = "100%", fig.cap="Sign up for 'Zenodo'"}
...
```{r include = TRUE, eval = TRUE, echo = FALSE, fig.align='center', out.width = "100%", fig.cap="Authorize  to connect with 'GitHub'"}
...
```{r include = TRUE, eval = TRUE, echo = FALSE, fig.align='center', out.width = "100%", fig.cap="Enable individual 'GitHub' repositories to be archived in 'Zenodo'"}
...
```{r include = TRUE, eval = TRUE, echo = FALSE, fig.align='center', out.width = "100%", fig.cap="Check the new release has been uploaded."}
...
```{r include = TRUE, eval = TRUE, echo = FALSE, fig.align='center', out.width = "100%", fig.cap="Click the orange Edit button."}
